...
if ( ! class_exists( 'Planet4_Gutenberg_Block_Gallery_3Column' ) ) {
	class Planet4_Gutenberg_Block_Gallery_3Column extends Blocks\Planet4_Gutenberg_Base_Block {
		...
		public function __construct() {
			if ( function_exists( 'acf_add_local_field_group' ) ) {
				acf_add_local_field_group( array(
					'key'                   => 'group_p4_gutenberg_gallery_3column',
					'title'                 => 'Planet4 Block: Gallery (3 Columns)',
					'fields'                => array(
						array(
							'key'               => 'field_p4_gutenberg_gallery_3column_images',
							'label'             => 'Images',
							'name'              => 'images',
							'type'              => 'gallery',
							'instructions'      => '',
					...
					'location'              => array(
						array(
							array(
								'param'    => 'block',
								'operator' => '==',
								'value'    => 'acf/p4block-gallery-3column',
							),
						),
					),
					'menu_order'            => 0,
