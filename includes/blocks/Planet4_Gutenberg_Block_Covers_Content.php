...
if ( ! class_exists( 'Planet4_Gutenberg_Block_Covers_Content' ) ) {
	class Planet4_Gutenberg_Block_Covers_Content extends Blocks\Planet4_Gutenberg_Base_Block {
		...
		public function __construct() {
			if ( function_exists( 'acf_add_local_field_group' ) ) {
				acf_add_local_field_group( array(
						'key'                   => 'group_p4_gutenberg_covers_content',
						'title'                 => 'Planet4 Block: Covers (Take Action)',
						'fields'                => array(
							array(
								'key'               => 'field_p4_gutenberg_covers_content_rows',
							...
							array(
								'key'               => 'field_p4_gutenberg_covers_content_tags',
							...
							array(
								'key'               => 'field_p4_gutenberg_covers_content_post_types',
							...
							array(
								'key'               => 'field_p4_gutenberg_covers_content_select_posts',
						...
						'location'              => array(
							array(
								array(
									'param'    => 'block',
									'operator' => '==',
									'value'    => 'acf/p4block-covers-content',
								),
							),
						),
						'menu_order'            => 0,
		...
		public function init_acf_block() {
			...
			if ( function_exists( 'acf_register_block' ) ) {
				...
				acf_register_block( array(
					...
					'title'           => __( 'Planet4: Covers (Posts)', 'planet4-gutenberg-blocks' ),
		...
		public function block_callback( $block ) {
			...
			$parameters = array(
				'cover_type'  => '3', // Sets the cover to type Take Action
